...
- **RSS-tabblad** — een eigen tabblad onderin (naast Meldingen en Kaart) met de volledige politie-RSS: getuigenoproepen, opsporingsberichten, vermiste personen en politienieuws, met hetzelfde tijdfilter als de rest van de app. Op foldables blijft de balk zichtbaar naast de two-pane weergave.
