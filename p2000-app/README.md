...
- **Eigen filters per scherm** — *In de buurt* en de kaart delen één filterset; *Alles* heeft een eigen set (types, locatietekst, tijdvenster en straal), die apart wordt bewaard. Het filterpaneel toont welk scherm je aanpast. Op het Alles-scherm staat de straal standaard uit; met de schuif op 0 werk je bewust zonder afstandsfilter.
